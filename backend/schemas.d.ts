...
export interface ApiCatagoryCatagory extends CollectionTypeSchema {
  info: {
...
export interface ApiProductProduct extends CollectionTypeSchema {
  ...
  attributes: {
    ...
    type: EnumerationAttribute<['normal', 'featured', 'trending']> &
      DefaultTo<'normal'>;
    catagories: RelationAttribute<
      'api::product.product',
      'manyToMany',
      'api::catagory.catagory'
    >;
    sub_catagories: RelationAttribute<
      'api::product.product',
      'manyToMany',
      'api::sub-catagory.sub-catagory'
    >;
    createdAt: DateTimeAttribute;
    updatedAt: DateTimeAttribute;
    publishedAt: DateTimeAttribute;
...
export interface ApiSubCatagorySubCatagory extends CollectionTypeSchema {
  info: {
...
declare global {
  namespace Strapi {
    interface Schemas {
      ...
      'api::sub-catagory.sub-catagory': ApiSubCatagorySubCatagory;
