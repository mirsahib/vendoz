        ...
        <header className="sticky text-gray-600 bg-white body-font border-b-2 border-gray-300">
            <div className="container md:w-[92%] mx-auto flex flex-wrap p-3  md:p-1 flex-col md:flex-row  justify-between">
                ...
                <div
                    ...
                    className="absolute z-10 md:z-auto text-xl right-5 cursor-pointer md:hidden"
                >
                    <FontAwesomeIcon icon={open ? faXmark : faBars} />
                </div>
                <nav
                    className={`flex md:items-center  md:flex-row flex-wrap flex-col  text-base absolute md:static z-[-1] md:z-auto md:my-3 bg-white  w-full md:w-auto left-0 top-[4.4em] pl-6 md:pl-0 transition-all duration-200 ease-in-out ${
                        open
                            ? "top-[4.4em] opacity-100"
                            : "top-[0.75em] opacity-0 md:opacity-100"
                    }`}
                >
                    <Link
